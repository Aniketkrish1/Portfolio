  ...
  return (
    <section id="experience" className="py-16 lg:py-20 bg-[#0a0a0b]">
      <Container>
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
              <div>
                ...
                <div className="font-mono text-sm text-[#3ecf8e] font-semibold mt-0.5">Finance Tracker | Freelance Backend Developer</div>
              </div>
        ...
        <Reveal delay={0.2}>
          <div className="mt-16 p-6 sm:p-8 rounded-xl bg-[#111113]/60 border border-[#1f1f23] hover:border-[#3ecf8e]/40 transition-all duration-300">
